...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .game-screen.active { display: flex; flex-direction: column; gap: 30px; }
    ...
    .rankings { background: rgba(0, 0, 0, 0.8); padding: 20px; border-radius: 10px; border: 2px solid #FF00FF; max-height: 400px; overflow-y: auto; }
  ...
  <div class="container">
    ...
    <div class="game-screen" id="game-screen">
      ...
      <div class="button-group">
        ...
        <button class="nav-btn" onclick="toggleRankings()">Rankings</button>
        <button class="nav-btn" onclick="showHistory()">History</button>
      </div>
      <div class="rankings" id="rankings" style="display: none;"></div>
    </div>
...
function updateUI(data) {
    ...
    function toggleRankings() {
      const rankingsEl = document.getElementById('rankings');
      rankingsEl.style.display = rankingsEl.style.display === 'none' ? 'block' : 'none';
    }
